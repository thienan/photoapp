...
import com.pinterest.android.pdky.PDKYCallback;
import com.pinterest.android.pdky.PDKYClient;
import com.pinterest.android.pdky.PDKYException;
import com.pinterest.android.pdky.PDKYResponse;
...
import org.quantum.silverphoto.data.local.DatabaseHelper;
import org.quantum.silverphoto.gallery.activities.SettingsActivity;
import org.quantum.silverphoto.gallery.util.AlertDialogsHelper;
import org.quantum.silverphoto.share.flickr.FlickrActivity;
import org.quantum.silverphoto.share.imgur.ImgurAuthActivity;
import org.quantum.silverphoto.share.nextcloud.NextCloudAuth;
import org.quantum.silverphoto.share.owncloud.OwnCloudActivity;
import org.quantum.silverphoto.share.tumblr.TumblrClient;
import org.quantum.silverphoto.share.twitter.LoginActivity;
...
import static com.pinterest.android.pdky.PDKYClient.setDebugMode;
import static org.quantum.silverphoto.R.string.no_account_signed_in;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.BOX;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.DROPBOX;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.FACEBOOK;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.GOOGLEDRIVE;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.IMGUR;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.NEXTCLOUD;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.ONEDRIVE;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.OWNCLOUD;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.PINTEREST;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.TUMBLR;
import static org.quantum.silverphoto.data.local.AccountDatabase.AccountName.TWITTER;
import static org.quantum.silverphoto.utilities.Constants.BOX_CLIENT_ID;
import static org.quantum.silverphoto.utilities.Constants.BOX_CLIENT_SECRET;
import static org.quantum.silverphoto.utilities.Constants.PINTEREST_APP_ID;
import static org.quantum.silverphoto.utilities.Constants.SUCCESS;
...
public class AccountActivity extends ThemedActivity implements AccountContract.View,
    ...
    private void signInPinterest() {
        ...
        scopes.add(PDKYClient.PDKYCLIENT_PERMISSION_READ_PUBLIC);
        scopes.add(PDKYClient.PDKYCLIENT_PERMISSION_WRITE_PUBLIC);
        scopes.add(PDKYClient.PDKYCLIENT_PERMISSION_READ_RELATIONSHIPS);
        scopes.add(PDKYClient.PDKYCLIENT_PERMISSION_WRITE_RELATIONSHIPS);

        pdkyClient.login(this, scopes, new PDKYCallback() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        pdkyClient.onOauthResponse(requestCode, resultCode, data);
