...
import org.quantum.silverphoto.BuildConfig;
import org.quantum.silverphoto.R;
import org.quantum.silverphoto.base.ThemedActivity;
import org.quantum.silverphoto.gallery.util.CustomTabService;
...
//        ((TextView) findViewById(R.id.about_support_report_bug_sub)).setTextColor(color);
    ...
    private void licenseDialog() {
        ...
        notices.addNotice(
                new Notice(
                        getApplicationContext().getString(R.string.quantumphotoview),
                        getApplicationContext().getString(R.string.quantumphotoview_github),
