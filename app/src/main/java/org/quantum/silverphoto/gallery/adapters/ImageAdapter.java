package org.quantum.silverphoto.gallery.adapters;
...
import uk.co.senab.quantumphotoview.QuantumPhotoViewAttacher;

import static org.quantum.silverphoto.utilities.ActivitySwitchHelper.context;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imageView = new QuantumPhotoView(ActivitySwitchHelper.context);
            imageView.setOnPhotoTapListener(new QuantumPhotoViewAttacher.OnPhotoTapListener() {
                @Override
