...
public interface IQuantumPhotoView
{
    ...
    /**
     * Returns true if the QuantumPhotoView is set to allow zooming of Photos.
     *
     * @return true if the QuantumPhotoView allows zooming.
     */
    boolean canZoom();
     ...
     *
     * @param finalMatrix target matrix to set QuantumPhotoView to
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(QuantumPhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(QuantumPhotoViewAttacher.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(QuantumPhotoViewAttacher.OnViewTapListener listener);

    /**
     * Enables rotation via QuantumPhotoView internal functions.
     *
     * @param rotationDegree - Degree to rotate QuantumPhotoView to, should be in range 0 to 360
     */
     ...
     * Enables rotation via QuantumPhotoView internal functions.
     *
     * @param rotationDegree - Degree to rotate QuantumPhotoView by, should be in range 0 to 360
     */
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (QuantumPhotoViewAttacher.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of IQuantumPhotoView (eg. QuantumPhotoViewAttacher), can be used to provide better
     * integration
     *
     * @return IQuantumPhotoView implementation instance if available, null if not
     */
    IQuantumPhotoView getIQuantumPhotoViewImplementation();

    /**
     * Sets custom double tap listener, to intercept default given functions. To reset behavior to
     * default, you can just pass in "null" or public field of QuantumPhotoViewAttacher.defaultOnDoubleTapListener
     *
     ...
     */
    void setOnScaleChangeListener(QuantumPhotoViewAttacher.OnScaleChangeListener onScaleChangeListener);
     ...
     */
    void setOnSingleFlingListener(QuantumPhotoViewAttacher.OnSingleFlingListener onSingleFlingListener);
}
