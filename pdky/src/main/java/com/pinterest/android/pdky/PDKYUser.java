...
public class PDKYUser extends PDKYModel {
    ...
    public static PDKYUser makeUser(Object obj) {
        PDKYUser user = new PDKYUser();
        try {
            ...
            Utils.loge("pdky: pdkyUser parse JSON error %s", e.getLocalizedMessage());
        } catch (ParseException e) {
            Utils.loge("pdky: pdkyUser parse error %s", e.getLocalizedMessage());
        }
        return user;
    }

    public static List<PDKYUser> makeUserList(Object obj) {
        List<PDKYUser> userList = new ArrayList<PDKYUser>();
        try {
            ...
            Utils.loge("pdky: pdkyUserList parse JSON error %s", e.getLocalizedMessage());
        }
        return userList;
    }
}
