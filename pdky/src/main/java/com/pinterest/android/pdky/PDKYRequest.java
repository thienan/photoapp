...
public class PDKYRequest extends JsonObjectRequest {

    private PDKYCallback _callback;
    private Map<String, String> _headers = null;

    public PDKYRequest(int method, String url, JSONObject jsonRequest,
        Response.Listener<JSONObject> listener,
        Response.ErrorListener errorListener) {
        super(method, url, jsonRequest, listener, errorListener);
    }

    public PDKYRequest(int method, String url, JSONObject object, PDKYCallback callback, Map<String, String> headers) {
