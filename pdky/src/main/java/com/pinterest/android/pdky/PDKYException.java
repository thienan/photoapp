...
public class PDKYException extends Exception {
    ...
    public PDKYException() {
        super();
    }

    public PDKYException(String message) {
        super(message);
        _detailMessage = message;
    }

    public PDKYException(String message, Throwable throwable) {
        super(message, throwable);
    }

    public PDKYException(VolleyError error) {
        super();
        String message = "";
